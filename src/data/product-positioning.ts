export const CANONICAL_POSITIONING =
...
export const paidAfterJulyItems = [
...
export const productFacts = [
  ...
  {
    label: "Paid layer",
    value: "Full audio access and premium resources after 8 July 2026",
  },
  {
    label: "Exam alignment",
    value: "RCGP curriculum, current AKT format, NICE CKS and BNF where relevant",
  },
  {
    label: "Affiliation",
...
export const homePositioningFaqs = [
  {
