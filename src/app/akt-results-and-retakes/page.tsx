        ...
        <div className="container-x max-w-[820px]">
          ...
          <section className="mt-10">
            ...
            <p
              ...
              style={{ color: "var(--fg-mid)" }}
            >
              If organisation or safety-system questions were weak, use the{" "}
              <a
              ...
              to revise audit, QI, significant-event learning, continuity,
              handover, test-result follow-up and patient-safety systems.
            </p>
            <p
              className="mt-3 text-[16px] leading-[1.7]"
              style={{ color: "var(--fg-mid)" }}
